        ...
        <main>  
            <div id="detalhe_produto">
                <ul>
                    ...
                    <li><b>C&oacutedigo: </b><?php echo $codigobarra; ?></li>
                    <li><b>Tempo de Entrega: </b><?php echo $tempoentrega; ?></li>
                    <li><b>Pre&ccedil;o Revenda: </b><?php echo money_format('%.2n',$precorevenda); ?></li>
                    <li><b>Pre&ccedil;o Unit&aacute;rio: </b><?php echo money_format('%.2n',$precounitario); ?></li>
